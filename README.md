...
### ✅ 완료된 기능
1. **사용자 관리** - 5가지 권한 레벨 (학생/학부모/교사/관리자/최고관리자)
2. **학생 관리** - 20+ 필드 (기본정보, 보호자, 학력, 건강정보)
3. **학기/과목 관리** - 학기별 과목 관리, 교사-과목 연결
4. **반 관리** - 반 생성, 학생 배정, 담임 배정
5. **출석 관리** - 날짜별 출석 입력, 통계, 검색/필터링 (담임+과목 교사)
6. **성적 관리** - 학생별 수강 과목 조회, 반별 성적 현황 (담임+과목 교사)
7. **봉사활동 관리** - 활동 등록, 승인, 통계
8. **동아리 관리** - 동아리 생성, 회원 관리, 활동 기록
9. **상담 관리** - 상담 기록 CRUD, 유형별 분류 (담임+과목 교사)
10. **시스템 설정** - 학교 정보, 출석/성적/봉사 설정
11. **담임 배정** - 학기별 담임 교사 관리
12. **성적표 출력** - 학기별 성적표 조회 및 PDF 출력
13. **생활기록부** - 종합 학생 정보 조회 및 PDF 출력
14. **교사 권한 관리** - 과목별 담당 교사 배정, 권한 세분화
